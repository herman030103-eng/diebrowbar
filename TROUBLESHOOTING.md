...
**Причина:** Несовместимость типов данных при работе с IMAP командами.

**Решение:** Исправлено в последней версии. Email ID теперь правильно конвертируется в bytes.
...
**Для Gmail:**
Некоторые системные папки нельзя изменить:
- `[Gmail]/All Mail` - можно только читать
- `[Gmail]/Trash` - для удаленных
- `[Gmail]/Spam` - для спама
